	...
	init() {
		this.steps = [
			...
			},
			{
				...
				content: {
					ru: 'Здесь хранятся ваши достижения, рейтинг и история ваших отчетов.',
					en: 'Your achievements, rating, and report history are stored here.',
					uz: 'Bu yerda yutuqlaringiz, reytingingiz va hisobotlaringiz tarixi saqlanadi.',
				},
				position: 'center',
			},
			{
				...
				title: {
					ru: '⭐ Ваш рейтинг',
					en: '⭐ Your Rating',
					uz: '⭐ Sizning reytingingiz',
				},
				content: {
					ru: 'Повышайте свой рейтинг, очищая город! Чем выше рейтинг, тем больше ваш вклад в экологию.',
					en: 'Increase your rating by cleaning the city! The higher the rating, the greater your contribution to the environment.',
					uz: "Shaharni tozalab reytingingizni oshiring! Reyting qancha yuqori bo'lsa, ekologiyaga qo'shgan hissangiz shuncha katta bo'ladi.",
				},
				position: 'center',
			},
			{
