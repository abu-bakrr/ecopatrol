	...
	init() {
		this.steps = [
			...
			},
			{
				...
				content: {
					ru: 'Зарабатывайте деньги, очищая город! Чем больше вы убираете, тем выше ваш баланс.',
					en: 'Earn money by cleaning the city! The more you clean, the higher your balance.',
					uz: "Shaharni tozalab pul ishlang! Qancha ko'p tozalasangiz, balansingiz shuncha yuqori bo'ladi.",
				},
				position: 'center',
			},
			{
